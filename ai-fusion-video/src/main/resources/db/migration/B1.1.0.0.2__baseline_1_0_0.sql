...
-- Flyway baseline migration for product version 1.0.0.
-- Generated from a clean MySQL 8.0 database after applying all V migrations
-- through V1.1.0.0.2. It intentionally excludes flyway_schema_history.
...
INSERT INTO `afv_system_config` (`id`, `config_key`, `config_value`, `remark`, `deleted`, `create_time`, `update_time`) VALUES (1,'allow_register','false','是否允许公开注册',0,'2026-07-23 09:37:45','2026-07-23 09:37:45');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
INSERT INTO `sys_role` (`id`, `name`, `code`, `sort`, `status`, `remark`, `deleted`, `create_time`, `update_time`) VALUES (1,'超级管理员','admin',1,1,'系统超级管理员',0,'2026-04-16 16:03:20','2026-04-16 16:03:20');
INSERT INTO `sys_role` (`id`, `name`, `code`, `sort`, `status`, `remark`, `deleted`, `create_time`, `update_time`) VALUES (2,'普通用户','user',2,1,'默认用户角色',0,'2026-04-16 16:03:20','2026-04-16 16:03:20');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
